...
text-green-500 mr-4" size={24} />
              ...
              <div className="mt-8">
                ...
                <a href="https://wa.me/5511946843380" target="_blank" rel="noopener noreferrer" className="inline-flex items-center bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full transition duration-300">
